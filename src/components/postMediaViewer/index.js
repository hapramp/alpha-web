    ...
    switch (this.props.media.type) {
        ...
        return (<div className={[this.props.className, 'uk-flex', 'uk-flex-center', 'uk-margin-bottom'].join(' ')}>
          <div className="uk-inline">
            <img
              ...
              src={window.URL.createObjectURL(this.props.media.content)}
              alt="Media"
              id="media-image"
            />
            <div
      ...
      case 'youtube':
        return (<div className={[this.props.className, 'uk-cover-container', 'uk-medium-height'].join(' ')}>
          <iframe
            title={this.props.media.content}
            src={`https://www.youtube.com/embed/${this.props.media.content}?rel=0&amp`}
            width="100%"
            height="315"
            frameBorder="0"
            allowFullScreen
