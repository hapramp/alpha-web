...
class PostSingle extends React.Component {
  ...
  getRightSection() {
    const containsImage = this.props.post.json_metadata.content.data[0].type.toLowerCase() === 'image'
    ...
    const data = containsImage ? this.props.post.json_metadata.content.data[1] : this.props.post.json_metadata.content.data[0];
